...
//                                        Log.e("TAG", "initSuccess: " + name + "__" + "图片合格 " + Utils.addZero(name));
    ...
    public class SDCardFileExplorerAdapter extends RecyclerView.Adapter<SDCardFileExplorerTestActivity.SDCardFileExplorerHolder> implements View.OnClickListener {
        ...
        public SDCardFileExplorerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            SDCardFileExplorerTestActivity.SDCardFileExplorerHolder viewHolder = new SDCardFileExplorerTestActivity.SDCardFileExplorerHolder(view);
