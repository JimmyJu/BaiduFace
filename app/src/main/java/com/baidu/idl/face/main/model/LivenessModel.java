...
public class LivenessModel {
    ...
    private float featureContrastValue;
    ...
    public float getFeatureContrastValue() {
        return featureContrastValue;
    }

    public void setFeatureContrastValue(float featureContrastValue) {
        this.featureContrastValue = featureContrastValue;
    }
