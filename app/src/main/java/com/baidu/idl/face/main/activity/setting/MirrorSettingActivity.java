...
public class MirrorSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mSwitchMusic = findViewById(R.id.switch_music);
    ...
    private void initData() {
        ...
        if (SingleBaseConfig.getBaseConfig().getMusicSwitch() == zero) {  // 有音效
            mSwitchMusic.setChecked(false);
        } else if (SingleBaseConfig.getBaseConfig().getMusicSwitch() == one) {  // 无音效
        ...
        switch (view.getId()) {
            case R.id.button_mirror_save:
                ...
                if (mSwitchMusic.isChecked()) {
                    SingleBaseConfig.getBaseConfig().setMusicSwitch(one);
                } else {
                    SingleBaseConfig.getBaseConfig().setMusicSwitch(zero);
                }
