...
//            SingleBaseConfig.getBaseConfig().setRadius(jsonObject.getInt("radius"));
            ...
            SingleBaseConfig.getBaseConfig().setMusicSwitch(jsonObject.getInt("musicSwitch"));
...
//            int radius = (int) jsonObject.get("radius");
            ...
            int musicSwitch = jsonObject.getInt("musicSwitch");
            if (!(musicSwitch == 0 || musicSwitch == 1)) {
                return false;
            }
...
//            jsonObject.put("dPass", SingleBaseConfig.getBaseConfig().getdPass());
            ...
            jsonObject.put("musicSwitch", SingleBaseConfig.getBaseConfig().getMusicSwitch());
            // 修改内容写入配置文件
