...
public class FaceAuthActicity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        Log.d("TAG", "设备硬件指纹: " + faceAuth.getDeviceId(this));
        // 输入序列码
                    ...
                    if (code == 0) {
                        FaceSDKManager.getInstance().initModel(mContext, new SdkInitListener() {
                            ...
                            public void initModelSuccess() {
                                startActivity(new Intent(FaceAuthActicity.this, FaceRGBCloseDebugSearchActivity.class));
                            }
                ...
                public void onResponse(final int code, final String response) {
                    if (code == 0) {
                        FaceSDKManager.getInstance().initModel(mContext, new SdkInitListener() {
                            ...
                            @Override
                            public void initModelSuccess() {
                                LiveDataBus.get().with("offlineActivation").postValue(true);
                                finish();
                            }
