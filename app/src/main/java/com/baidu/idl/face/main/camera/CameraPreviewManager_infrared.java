...
public class CameraPreviewManager_infrared implements TextureView.SurfaceTextureListener {
    ...
    public static final int CAMERA_FACING_BACK = 0;//红外

    public static final int CAMERA_FACING_FRONT = 1;//彩色
...
//        Log.e(TAG, "相机。。。：参数1：" + texture + ",参数2：" + i + ",参数3：" + i1);
    }
    ...
    /**
     * 更新指定的SurfaceTexture时调用
     *
     * @param texture
     */
    @Override
    public void onSurfaceTextureUpdated(SurfaceTexture texture) {
//        Log.e(TAG, "更新指定的SurfaceTexture时调用：" + texture.on);
    }
            ...
            if (mCamera == null) {
                ...
                mCamera.setErrorCallback(new Camera.ErrorCallback() {
                    ...
                    public void onError(int error, Camera camera) {
                        ...
                        ToastUtils.toast(mContext, "相机错误码onError:" + error);
                        if (error == 100) {
                            stopPreview();
                            openCamera();
                        }
                ...
                Log.d(TAG, "initCamera---open camera");
            }
