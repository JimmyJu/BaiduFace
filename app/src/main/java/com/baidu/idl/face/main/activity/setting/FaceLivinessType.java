...
public class FaceLivinessType extends BaseActivity {
    ...
    public void justify() {
        if (liveTypeValue == one) {
            ...
            SingleBaseConfig.getBaseConfig().setRgbAndNirWidth(720);
            SingleBaseConfig.getBaseConfig().setRgbAndNirHeight(960);
        }
        if (liveTypeValue == two) {
    ...
    public void cameraSelect() {
        if (cameraTypeValue == zero) {
            ...
            SingleBaseConfig.getBaseConfig().setRgbAndNirWidth(720);
            SingleBaseConfig.getBaseConfig().setRgbAndNirHeight(960);
            SingleBaseConfig.getBaseConfig().setDepthWidth(720);
            SingleBaseConfig.getBaseConfig().setDepthHeight(960);
        }
        if (cameraTypeValue == one) {
